...
public class UtGen {
	...
	public static boolean debug=false;
        private static String RutaArchivo="ejemplo_generado/MiniC_Tiny.tm";
	...
	public static int DM=4; 

	public static void emitirComentario(String c) throws IOException{
		if(debug) {
	 ...
	 */  
        ...
        public static void IniciarFile() throws IOException{
          
            EliminarFile(RutaArchivo);
            Set_nombre_archivo(RutaArchivo);
           // System.out.println(RutaArchivo);
            archivo = new FileWriter(RutaArchivo,true);
            bw = new BufferedWriter(archivo);
        }        
                
        public static void EliminarFile(String name){
            File arch=new File(RutaArchivo);
          arch.delete();
            
        }
       
        public static void EscribirFile(String cadena) throws IOException{
            if(bandera){
                if(!debug)
                    bw.write(cadena+"\n");
                else
        ...
        public static void FinalizarFile() throws IOException{
            bw.close();
        }    
        public static void Set_nombre_archivo(String ruta){
            RutaArchivo=ruta;
        }
        public static String Get_nombre_archivo(){
            return RutaArchivo;
        }
        
	public static void emitirRO(String op, int r, int s, int t, String c) throws IOException{
            EscribirFile(instruccionActual +":       "+op+"       "+r+","+s+","+t);	
	 ...
	 * c = comentario a emitir en modo debug
	 */	
	public static void emitirRM(String op, int r, int d, int s, String c) throws IOException{
            EscribirFile(instruccionActual +":       "+op+"       "+r+","+d+"("+s+")");
	 ...
	 */	
	public static void cargarRespaldo( int direccion ) throws IOException{
	 ...
	 * c = comentario a emitir en modo debug
	 */
	public static void emitirRM_Abs(String op, int r, int a, String c) throws IOException{
            EscribirFile(instruccionActual +":       "+op+"       "+r+","+(a-(instruccionActual+1))+"("+PC+")");
